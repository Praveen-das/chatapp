      ...
      </div>
      {
        selectedConversation.invitationId ?
          <>
            <div className='flex gap-6 text-sm flex-col overflow-y-scroll py-6 no-scrollbar'>
              ...
              <div className='w-full flex px-8 gap-4 items-center '>
                <Avatar url={selectedConversation.profilePicture} size='50px' onlineIndication={false} />
              ...
              <div className='flex gap-1 flex-col w-full '>
                ...
                <div tabIndex={0} onClick={handleSendingInvitationLink} className='hover:bg-[--hover-secondary] w-full flex items-center gap-4 px-8 py-3 cursor-pointer'>
                ...
                <div onClick={handleCopyingLink} tabIndex={0} className='hover:bg-[--hover-secondary] w-full flex items-center gap-4 px-8 py-3 cursor-pointer'>
                  <div className='flex items-center justify-center w-[40px] h-[40px] bg-gray-500 rounded-full'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                ...
                <div onClick={handleGeneratingInvitationLink} tabIndex={0} className='hover:bg-[--hover-secondary] w-full flex items-center gap-4 px-8 py-3 cursor-pointer'>
                  <div className='flex items-center justify-center w-[40px] h-[40px] bg-gray-500 rounded-full'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
          ...
          <>
            ...
            <div tabIndex={0} onClick={handleGeneratingInvitationLink} className='hover:bg-[--hover-secondary] w-full flex items-center gap-4 px-8 py-3 cursor-pointer'>
              <div className='flex items-center justify-center w-[40px] h-[40px] bg-gray-500 rounded-full'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
