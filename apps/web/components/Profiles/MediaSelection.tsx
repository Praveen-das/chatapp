...
function MediaSelection({ conversationId }: { conversationId: string }) {
    ...
    if (!mediaStore.has(conversationId)) return null
    return (
        <div onClick={() => setProfileTab('media')} className='bg-base-100 capitalize w-full flex items-center justify-between gap-4 px-8 py-6 cursor-pointer'>
