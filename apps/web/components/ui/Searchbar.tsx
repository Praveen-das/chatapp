...
export default function Searchbar({ onChange, highlightElm, highlightResults = false }: ISearch) {
  ...
  return (
    <div className="flex gap-2 rounded-2xl px-3 py-2 bg-base-100 shadow-lg">
